...
Let's build a contact manager app. We will use a form to add new contacts to the list and display them in a list.

### AddPersonForm

Our AddPersonForm component uses state to manage the value of the text field:
